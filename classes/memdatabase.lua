...
function CMemDatabase:getPredictedBranches(id)
	...
	if( id >= 210000 and id < 214000 ) then
		return {0x84, 0x28C, 0x290, 0x294, 0x298, 0x29C, 0x2A0};
	end
	...
	if( id >= 240000 and id < 245000) then
		return {0x114, 0x118, 0x120, 0x124};
	end
	...
	if( id >= 490000 and id < 510000 ) then
		return {0x150, 0x154, 0x158, 0x15C, 0x160, 0x164, 0x168, 0x16C,
			0x170,0x174, 0x178, 0x190, 0x194, 0x198, 0x19C,
			0x1B0, 0x1B4, 0x1A0, 0x1A4, 0x1A8, 0x1AC};
	end
	
	-- Runes
	if( id >= 510000 and id < 520000 ) then
		return {0x6C, 0x70, 0x7C, 0x80};
	end
	...
	if( id >= 570000 and id < 60000 ) then
