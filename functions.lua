...
function utf8ToAscii(_str)
	_str = replaceUtf8(_str, 132);		-- δ
	_str = replaceUtf8(_str, 142);		-- Δ
	_str = replaceUtf8(_str, 148);		-- φ
	_str = replaceUtf8(_str, 153);		-- Φ
	_str = replaceUtf8(_str, 129);		-- ό
	_str = replaceUtf8(_str, 154);		-- ά
	_str = replaceUtf8(_str, 225);		-- ί
	return _str;
end
...
function asciiToUtf8(_str)
	_str = replaceAscii(_str, 132);		-- δ
	_str = replaceAscii(_str, 142);		-- Δ
	_str = replaceAscii(_str, 148);		-- φ
	_str = replaceAscii(_str, 153);		-- Φ
	_str = replaceAscii(_str, 129);		-- ό
	_str = replaceAscii(_str, 154);		-- ά
	_str = replaceAscii(_str, 225);		-- ί
	return _str;
end
