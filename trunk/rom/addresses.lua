...
addresses = {
	...
	functionMousePatchAddr = 0x62CB96,
	...
	functionTargetBytes = {0x56, 0x8B, 0xCD, 0xE8, 0xC9, 0xB7, 0x28, 0x00},
	functionTargetPatchAddr = 0x5F2BCF,
	...
	staticpattern_char = 0x5E6C97,
	staticpattern_macro = 0x763455,
