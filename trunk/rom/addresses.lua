...
addresses = {
	...
	camZ_offset = 0x10C,
	castingBarPtr = 0xA092C8,
	castingBar_offset = 0xC,
	charAlive_offset = 0x224,
	charBattle_offset = 0x732,
	charExp_address = 0x9B52F0,
	charMaxExpTable_address = 0xA01948,
