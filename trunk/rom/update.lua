...
local updatePatterns =
{
	...
	pawnHarvesting_offset = {
		pattern = string.char(0xFF, 0xD0,
			0x89, 0xAE, 0xFF, 0xFF, 0xFF, 0xFF,
			0x8B, 0x86, 0xFF, 0xFF, 0xFF, 0xFF,
			0x3B, 0xC5, 0x74, 0x2C, 0x8B, 0x8E),
		mask = "xxxx????xx????xxxxxx",
		offset = 10,
		startloc = 0x860000,
	},
...
0x83, 0xC0, 0x08),
	...
	eggPetMaxExpTablePtr = {
		pattern = string.char(0xF3, 0x0F, 0x2A, 0xC6,
			0xF3, 0x0F, 0x11, 0x44, 0x24, 0xFF,
			0x74, 0x24,
			0x8B, 0x0D, 0xFF, 0xFF, 0xFF, 0xFF,
			0x2B, 0xCA),
		mask = "xxxxxxxxx?xxxx????xx",
		offset = 14,
		startloc = 0x5F0000
	},
}
