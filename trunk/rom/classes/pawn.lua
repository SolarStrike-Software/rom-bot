...
CPawn = class(
	function (self, ptr)
		...
		self.FightStartX = 0.0;				-- players position at fight start
		self.FightStartZ = 0.0;				-- players position at fight start
		self.WpTouched = false;				-- we touched a waypoint while attacking a mob (as melee)
