language = {
	...
	[134] = "Due to technical reasons, we don't support modifiers like CTRL/ALT/SHIFT for hotkeys at the moment. Please change your hotkey %s-%s for hotkey TARGET_FRIEND.\n",
