...
local updatePatterns = 
{
	...
	castingBar_offset = {
		pattern = string.char(0x57, 0xFF, 0xD2, 0x8B, 0xF8, 0x8B, 0x44, 0x24, 0xFF, 0x89, 0x46, 0xFF, 0x8B, 0x44, 0x24, 0xFF, 0x85, 0xC0, 0x75, 0x05),
		mask = "xxxxxxxx?xx?xxx?xxxx",
		offset = 11,
		startloc = 0x770000,
		size = 1,
	},
	...
	staticTableSize = {
		pattern = string.char(0x83, 0xEC, 0x0C, 0x55, 0x33, 0xED, 0x39, 0x2D, 0xFF, 0xFF, 0xFF, 0xFF, 0x7E, 0x7F, 0x53, 0x56, 0x57),
		mask = "xxxxxxxx????xxxxx",
		offset = 8,
		startloc = 0x850000,
	},
	...
	pawnLootable_offset = {
		pattern = string.char(0x8A, 0x8D, 0xFF, 0xFF, 0xFF, 0xFF, 0x8A, 0x95, 0xFF, 0xFF, 0xFF, 0xFF, 0x80, 0xA5),
		mask = "xx????xx????xx",
		offset = 8,
		startloc = 0x850000,
	},
	...
	pawnPetPtr_offset = {
		pattern = string.char(0xC2, 0x08, 0x00, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0xCC, 0x8B, 0x81, 0xFF, 0xFF, 0xFF, 0xFF, 0x85, 0xC0, 0x75, 0x06, 0x8B, 0x81, 0xFF, 0xFF, 0xFF, 0xFF, 0xC3),
		mask = "xxx????xxxxxx????x",
		offset = 23,
		startloc = 0x84F000,
	},
	...
	pawnRace_offset = {
		pattern = string.char(0xF3, 0x0F, 0x11, 0x85, 0xFF, 0xFF, 0xFF, 0xFF,
		...
		mask = "xxxx????xx????xx????xx????xx????xx????xxxxxx????",
		offset = 44,
		startloc = 0x850000,
	},
