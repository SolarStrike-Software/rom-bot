...
function findOffsets()
	...
	local pattern = string.char(0xD9, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x10, 0xAE, 0x3D, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00);
	staticbase = findPatternInProcess(getProc(), pattern, "x?xxxxxxxx????xx", 0x00840000, 0x00100000) + 0xB;

	local pattern = string.char(0x16, 0x01, 0x00, 0x00, 0x00, 0x00, 0xA0, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x90, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00);
	staticcastbar = findPatternInProcess(getProc(), pattern, "xxxxxxx????xxxx????xxxx", 0x00840000, 0x00100000) + 0xE;
